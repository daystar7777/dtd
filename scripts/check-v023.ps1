...
Add-Result "v023.reference.count" ".dtd/reference has 18 markdown files (17 topics + index after v0.3.0e R1)" ($referenceFiles.Count -eq 18) "count=$($referenceFiles.Count)"

...
Add-Result "v023.reference.count" ".dtd/reference has 17 markdown files (16 topics + index after v0.3.0d)" ($referenceFiles.Count -eq 17) "count=$($referenceFiles.Count)"

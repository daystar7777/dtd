...
$IncludedPaths = @(
    ...
    "examples/realuse-benchmark-fixtures/README.md",
    "examples/realuse-benchmark-fixtures/valid-plain-row.jsonl",
    "examples/realuse-benchmark-fixtures/valid-dtd-row.jsonl",
    "examples/realuse-benchmark-fixtures/invalid-schema-version.jsonl",
    "examples/realuse-benchmark-fixtures/invalid-token-sum.jsonl",
    "examples/realuse-benchmark-fixtures/score-inflation.jsonl",
    "examples/realuse-benchmark-fixtures/unknown-mode.jsonl",
    "examples/realuse-benchmark-fixtures/no-evidence.jsonl",
    "examples/realuse-benchmark-fixtures/same-model-judge.jsonl",
    "examples/realuse-benchmark-fixtures/dryrun-with-evidence.jsonl",
    "examples/realuse-benchmark-fixtures/full-no-user-gate.jsonl",
    ...
    "scripts/check-v030a.ps1",
    "scripts/check-v030b.ps1",
    "scripts/check-v030c.ps1",
    "scripts/check-v030d.ps1",
    "scripts/check-v030e.ps1",
    "scripts/check-realuse-fixtures.ps1",
    "scripts/realuse-runner.ps1",
    ".dtd/instructions.md",
    ".dtd/config.md",
    ".dtd/state.md",
